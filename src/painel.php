        ...
        <main>
            ...
            <div class="container__container__form_icons">
                ...
                <div class="container_form">
                    ...
                    <h1 class="title_contato"><i class="icon icon-file-text-o"></i> Painel De Denuncias</h1>
                    <?php
                    echo "<div class='titulo__denuncia'>";
                    echo "<h2>$nome </h2>" . PHP_EOL;
                    echo "</div>";
...
<div class="container__container_footer text-center">
  ...
  <path d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm-1-5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zM4 8a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm0 2.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z"/>
            ...
            <span class="span__icons">
            <a href="./php/deletar.php?id=<?php print_r($atualId[0])?>"> <span class="span__icons">
<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-archive" viewBox="0 0 16 16">
  <path d="M0 2a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1v7.5a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 1 12.5V5a1 1 0 0 1-1-1V2zm2 3v7.5A1.5 1.5 0 0 0 3.5 14h9a1.5 1.5 0 0 0 1.5-1.5V5H2zm13-3H1v2h14V2zM5 7.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z"/>
            ...
            <span class="span__icons">
<?php
            echo "<a href='./email.php?RA=$RA&email=$email'> <span class='span__icons'>";
            echo "<svg xmlns='http://www.w3.org/2000/svg' width='50' height='50' fill='currentColor' class='bi bi-chat-dots' viewBox='0 0 16 16'>
