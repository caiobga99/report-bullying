...
<body>
    ...
    <main>
        ...
        <?php
        echo "<h1 class='title_contato'><i class='icon icon-file-text-o'></i> Resposta a denuncia de RA - $RA</h1>";
    ...
    ?>  
    <?php 
    echo "<form method='post' action='/CRUD-BULLYNG/src/php/EnviarEmail.php'>";
    ?>
                <div class="style-form-input full">
                    <input type="text" name="nome" required />
                    <label><i class="icon icon-user-1"></i> Nome do apoiador</label>
                </div>
